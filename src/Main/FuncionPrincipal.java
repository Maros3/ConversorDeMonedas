...
import ConversorDeMonedas.function;
import ConversorDeTemperatura.functionTemperatura;
...
public class FuncionPrincipal {
    public static void main (String[] args) {
        ...
        while(true) {
            ...
            "Menu", JOptionPane.QUESTION_MESSAGE, null, new Object[] {"Conversor de Moneda", "Conversor de Temperatura"}, 
            "Seleccion")).toString();
            ...
            if(ValidarNumero(input) == true) {
                ...
                monedas.ConversionDeMoneda(Minput);
